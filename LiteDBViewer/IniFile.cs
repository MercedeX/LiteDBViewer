...
public class IniFile: IDisposable
{
    ...
    {
        return Get(key, string.Empty, default(T));
    }
    ...
    {
        return Get(key, section, default(T));
    }
    ...
    /// <returns></returns>
    public T Get<T>(string key, string section, T @default)
    {
        T ret = @default;
        ...
        ret = (T)Convert.ChangeType(ini[section][key], typeof(T));
        return ret;
    }
    ...
    /// <param name="section">section</param>
    /// <returns></returns>
    public IEnumerable<string> AllKeys(string section)
    {
        if (!ini.ContainsKey(section))
            return new string[0];
    ...
    /// </summary>
    /// <returns></returns>
    public IEnumerable<string> Sections => ini.Keys.Where(t => t != "");
